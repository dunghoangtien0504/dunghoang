...
-- ─── 3. Bài 1: Tổng quan (free preview) ─────────────────────────────────────
...
-- ─── 4. Bài 2: Chuẩn bị thông tin ──────────────────────────────────────────
insert into lessons (course_id, title, description, content_html, sort_order, is_free, is_published, duration, host_note)
values (
  'meta-ai-agent',
  'Bước 1 — Chuẩn bị thông tin shop của bạn',
  'Thu thập đủ thông tin cần thiết trước khi điền vào template.',
  $$<div class="space-y-4 text-sm leading-relaxed text-gray-700">
...
-- ─── 5. Bài 3: Điền 4 tài liệu ──────────────────────────────────────────────
insert into lessons (course_id, title, description, content_html, sort_order, is_free, is_published, duration, host_note)
values (
  'meta-ai-agent',
  'Bước 2 — Điền vào 4 tài liệu template',
  'Dùng thông tin đã chuẩn bị ở Bước 1 để điền vào 4 tài liệu.',
  $$<div class="space-y-5 text-sm leading-relaxed text-gray-700">
    <p>Bạn có 4 tài liệu template trong file đã nhận qua email. Lần lượt điền vào từng cái:</p>
    <div class="border border-gray-200 rounded-xl overflow-hidden">
      ...
      <div class="p-5 space-y-2">
        ...
        <p class="text-gray-500 text-xs">💡 Viết ngắn gọn, thực tế. AI hiểu tốt nhất khi thông tin rõ ràng.</p>
      </div>
    </div>
    <div class="border border-gray-200 rounded-xl overflow-hidden mt-3">
      ...
      <div class="p-5 space-y-2">
        ...
        <p class="text-gray-500 text-xs">💡 Đây là phần quyết định AI nói chuyện tự nhiên hay như robot. Bỏ thời gian điền kỹ phần này.</p>
      </div>
    </div>
    <div class="border border-gray-200 rounded-xl overflow-hidden mt-3">
      ...
      <div class="p-5 space-y-2">
        <p>Điền vào các chủ đề AI cần tránh: đối thủ, thông tin chưa xác nhận, cam kết quá mức. Template đã có sẵn các mục phổ biến — bạn chỉ cần bỏ/thêm cho phù hợp.</p>
    ...
    <div class="border border-gray-200 rounded-xl overflow-hidden mt-3">
      ...
      <div class="p-5 space-y-2">
        <p>File này đã có sẵn 20+ câu hỏi mẫu. Bạn dùng ở Bước 4 để test AI sau khi cài xong.</p>
      </div>
    </div>
  </div>$$,
  3, false, true, 20,
...
-- ─── 6. Bài 4: Paste vào Meta ────────────────────────────────────────────────
insert into lessons (course_id, title, description, content_html, sort_order, is_free, is_published, duration, host_note)
values (
  'meta-ai-agent',
  'Bước 3 — Paste vào Meta Business Suite và bật AI',
  'Hướng dẫn từng bước paste nội dung vào đúng ô trong Meta Business Suite.',
  $$<div class="space-y-4 text-sm leading-relaxed text-gray-700">
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-2">
      ...
      <p class="text-amber-700 text-xs mt-1">Tài khoản của bạn phải là Admin của Facebook Page. Nếu chỉ là Editor thì không thấy mục AI Settings.</p>
    </div>
    <ol class="space-y-5">
      <li class="flex gap-4">
      ...
      <li class="flex gap-4">
        ...
        <div>
          ...
          <p class="text-gray-600 mt-1">Paste nội dung từ <strong>Tài liệu 1</strong> vào ô <em>About your business</em></p>
        </div>
      </li>
      <li class="flex gap-4">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-4">
      ...
      <p class="text-blue-700 text-xs mt-1">Meta đang roll out dần — một số tài khoản chưa có. Nhắn mình qua Telegram @KentHoang để được hỗ trợ thêm.</p>
    </div>
  </div>$$,
  4, false, true, 20,
  'Bước này dễ bị nhầm ở chỗ tìm đúng ô để paste. Nếu bạn thấy giao diện khác — cứ nhắn mình, Meta hay thay layout lắm.'
);
...
values (
  ...
  'Dùng Test Cases để kiểm tra AI trả lời đúng chưa trước khi mở cho khách thật.',
  $$<div class="space-y-4 text-sm leading-relaxed text-gray-700">
    ...
    <div class="bg-gray-50 border border-gray-200 rounded-xl p-5">
      ...
      <ol class="list-decimal list-inside space-y-2 text-gray-700 ml-2">
        ...
        <li>Nếu AI trả lời sai → quay lại Meta AI Settings và chỉnh Custom Instructions</li>
      </ol>
    </div>
    <div class="space-y-3 mt-4">
      ...
      <div class="border border-red-100 rounded-xl p-4 bg-red-50">
        ...
        <p class="text-red-700 text-xs mt-1">→ Thêm tên shop vào đầu Business Info: Chúng tôi là [Tên Shop]...</p>
      </div>
      <div class="border border-red-100 rounded-xl p-4 bg-red-50">
        <p class="font-semibold text-red-800 text-xs">❌ AI bịa giá hoặc thông tin sai</p>
        <p class="text-red-700 text-xs mt-1">→ Thêm vào Avoid Topics: Không đưa ra giá cụ thể, hướng khách nhắn để được tư vấn</p>
      </div>
      <div class="border border-red-100 rounded-xl p-4 bg-red-50">
        <p class="font-semibold text-red-800 text-xs">❌ AI không trả lời tiếng Việt</p>
        <p class="text-red-700 text-xs mt-1">→ Thêm vào Custom Instructions: Luôn trả lời bằng tiếng Việt, xưng "shop" với khách</p>
      </div>
    </div>
  ...
  5, false, true, 15,
  'Bước test này mất 15-20 phút nhưng cực kỳ quan trọng. Mình từng thấy shop bật AI ngay mà không test — khách hỏi sản phẩm thì AI lại trả lời về chính sách hoàn tiền. Mất khách oan.'
);
