...
const COURSE_INFO: Record<string, { name: string; drive_link: string; telegram_link: string }> = {
  ...
  'landing-page': { name: 'Landing Page Siêu Chuyển Đổi',         drive_link: 'https://dunghoang.com/portal', telegram_link: 'https://t.me/KentHoang' },
  'khoa-1':     { name: '24 AI Agent for Business',              drive_link: 'https://dunghoang.com/portal', telegram_link: 'https://t.me/KentHoang' },
